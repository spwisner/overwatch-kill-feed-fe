...
const PrimalRange = ({ width, height, fill }) => (
	<svg className="HeroAbility-icon" viewBox="0 0 40 40" width={width} height={height} fill={fill}>
		<g id="_Group_" data-name="&lt;Group&gt;">
			...
			<path
				...
				data-name="&lt;Path&gt;"
				className="cls-1"
				d="M30.52,22.09a12.22,12.22,0,0,1-1.4-.37c.11-.27.19-.52.31-.75.48-1,.88-2,1.31-3s.82-1.83,1.17-2.77a10.09,10.09,0,0,0,.68-2.41,1.77,1.77,0,0,0-.46-1.42c-.44-.51-.88-1-1.32-1.54-.23-.27-.21-.47.06-.71a.44.44,0,0,1,.7,0c.48.59.95,1.19,1.43,1.78a2.83,2.83,0,0,1,.42,2.57c-.44,1.95-1.17,3.81-1.78,5.7-.27.84-.58,1.66-.91,2.47C30.67,21.81,30.6,21.93,30.52,22.09Z"
			/>
			<path
				id="_Path_2"
				data-name="&lt;Path&gt;"
				className="cls-1"
				d="M12.6,17.68c.13-.5-.2-.6-.46-.75a.51.51,0,0,1-.26-.72c.07-.19.24-.23.4-.28.61-.2,1.24-.38,1.84-.6.92-.34,1.84-.64,2.78-.92,1.11-.34,2.21-.7,3.34-.95a2.41,2.41,0,0,1,2.17.47c.4.33.85.6,1.28.9a1.16,1.16,0,0,1,.29.28,1.39,1.39,0,0,1-.17.62c-.22.12-.35,0-.52-.13a8.85,8.85,0,0,0-1.75-1.35,1,1,0,0,0-.72-.07A9.91,9.91,0,0,0,18.6,15q-1.11.48-2.2,1c-.65.3-1.29.64-1.95.94S13.27,17.4,12.6,17.68Z"
			/>
			<path id="_Path_3" data-name="&lt;Path&gt;" className="cls-1" d="M13.13,23l2.18.84,0,.09-2.18-.84Z" />
			<path
				id="_Path_4"
				data-name="&lt;Path&gt;"
				className="cls-1"
				d="M12.81,23.5a.72.72,0,0,1,.56.34A.93.93,0,0,1,12.81,23.5Z"
			/>
			<path
				id="_Path_5"
				data-name="&lt;Path&gt;"
				className="cls-1"
				d="M14.1,24.78a1.39,1.39,0,0,1-.52-.56l.57.49Z"
			/>
			<path
				id="_Path_6"
				data-name="&lt;Path&gt;"
				className="cls-1"
				d="M11.73,23.86c.14,0,.17.09.22.2C11.8,24.05,11.76,24,11.73,23.86Z"
			/>
			<path
				id="_Path_7"
				data-name="&lt;Path&gt;"
				className="cls-1"
				d="M13.71,23.43c0,.08-.08.09-.16.08S13.62,23.42,13.71,23.43Z"
			/>
			<path
				id="_Path_8"
				data-name="&lt;Path&gt;"
				className="cls-1"
				d="M14.92,22.69c0-.06.07-.06.11,0S15,22.69,14.92,22.69Z"
			/>
			<path
				id="_Path_9"
				data-name="&lt;Path&gt;"
				className="cls-1"
				d="M22.34,26.65a1.38,1.38,0,0,1-.76.06,2.09,2.09,0,0,1,.77-.05Z"
			/>
			<path
				id="_Path_10"
				data-name="&lt;Path&gt;"
				className="cls-1"
				d="M9.6,20.9c.11,0,.16,0,.14.15S9.59,21,9.6,20.9Z"
			/>
			<path id="_Path_11" data-name="&lt;Path&gt;" className="cls-1" d="M9.94,20.65l0,.27a.18.18,0,0,1,0-.27Z" />
		</g>
	</svg>
)

PrimalRange.propTypes = propTypes

export default memo(PrimalRange)
